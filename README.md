...
## LINUX BASED SYSTEMS:
[(Link to Linux Setup Readme)](https://github.com/noaa-ocs-modeling/autoval/blob/v3.0.1/README_LINUX.md) 

## WINDOWS BASED SYSTEMS: 
[(Link to Windows Setup Readme)](https://github.com/noaa-ocs-modeling/autoval/blob/v3.0.1/README_WINDOWS.md)
